  ...
  return (
    <section aria-labelledby="page-title">
      ...
      <div className="mb-7 mt-7 flex flex-wrap items-end justify-between gap-4">
        ...
        <span className="rounded-full bg-white px-4 py-2 text-sm font-bold text-slate-600 shadow-sm">1 个演示账号</span>
      </div>
      <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <h3 className="mt-7 text-lg font-black">复盘列表</h3>
        {report.reviews.length === 0 ? <div className="mt-4"><EmptyState title="还没有复盘" message="保存复盘后会出现在这里。" /></div> : (
