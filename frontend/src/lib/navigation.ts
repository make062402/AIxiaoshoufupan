...
export function resolveRoute(pathname: string): RouteSnapshot {
  ...
  if (effectivePath === '/me/customers') {
    return { kind: 'page', route: 'customers', path: effectivePath }
  }
  if (['/me/scripts', '/me/products', '/me/config', '/me/team-reports'].includes(effectivePath)) {
